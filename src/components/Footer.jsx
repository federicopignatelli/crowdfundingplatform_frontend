...
const Footer = () => {
    ...
    return (
        <footer className=" bg-white text-gray-400 py-2 w-full border-y border-gray-300 mt-52">
                    ...
                    <ul className="text-xs md:text-sm md:flex md:flex-row">
                        <li className="mx-4">
                            <Link
                                ...
                                isExternal
                                showAnchorIcon
                                href="https://github.com/federicopignatelli"
                                anchorIcon={
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ms-3" viewBox="0 0 16 16">
                        ...
                        <li className="mx-4">
                            <Link
                                ...
                                isExternal
                                showAnchorIcon
                                href="https://www.linkedin.com/in/federicopignatelli-developer/"
                                anchorIcon={
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ms-3" viewBox="0 0 16 16">
